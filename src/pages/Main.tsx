...
const Main = ({ notes, availableTags }: Props) => {
    ...
    /*
      ...
      2) 2.input ile seçilen etiketler note'un içerisindeki etiketler ile birebir eşleşmelidir. Seçilen etiket dizisindeki her bir etiket için note'a ait etiketler arasında eşleşme kontolü yapılmalı.
      */
